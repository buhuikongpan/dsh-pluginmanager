window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const s = {
			...
			cards: "pm_cards", card: "pm_card", cardTitle: "pm_cardTitle", cardHint: "pm_cardHint", back: "pm_back"
		};
		//#endregion
		//#region locales
		const zh = {
			...
			empty: "没有匹配的插件。",
			legend: "系统层：agent 核心运转 | WebUI 层：浏览器界面 | 工具层：模型工具 | 用户扩展：可停用/卸载",
			sectionSystem: "系统层",
		...
		const en = {
			...
			legend: "System: agent core | WebUI: browser surface | Tools: model tools | User extensions: stop/uninstall enabled",
			...
			confirmUninstall: "Permanently uninstall {name}?\nThis removes the activation row, dependency entry and package directory; effective after a service restart.",
			doneEnable: "Disabled: ",
			doneDisable: "Enabled: ",
		...
		/** One top-level entry card that drills into a sub-view. */
		function EntryCard(props) {
			return react_jsx_runtime.jsxs("button", {
				...
				children: [
					...
					react_jsx_runtime.jsx("span", { className: s.chevron, "data-open": true, "aria-hidden": "true", children: "›" })
				]
			});
		}

		/** The manager tab: five sections over the host snapshot. */
		function ManagerTab(props) {
			...
			const run = (name, verb, call, donePrefix, failPrefix) => {
				...
				call().then((result) => {
					...
					setNotice({ kind: "success", text: donePrefix + name });
			...
			return react_jsx_runtime.jsxs("div", {
				...
				children: [
					...
					state.status === "error" ? react_jsx_runtime.jsxs("div", {
						className: s.failure,
						role: "alert",
						children: [react_jsx_runtime.jsx("p", { children: t("failed") }), react_jsx_runtime.jsx("button", { type: "button", onClick: refresh, children: t("retry") })]
					}) : null,
					state.status === "ready" ? react_jsx_runtime.jsxs("div", {
						className: s.blocks,
						children: [
							view === "home" ? react_jsx_runtime.jsx("div", {
								className: s.cards,
								children: [
									react_jsx_runtime.jsx(EntryCard, { t, title: t("cardNative"), count: nativeRows.length, hint: t("cardNativeHint"), onClick: () => setView("native") }),
									react_jsx_runtime.jsx(EntryCard, { t, title: t("cardUser"), count: userRows.length, hint: t("cardUserHint"), onClick: () => setView("user") }),
									react_jsx_runtime.jsx(EntryCard, { t, title: t("cardDynamic"), count: dynamicRows.length, hint: t("cardDynamicHint"), onClick: () => setView("dynamic") })
								]
							}) : null,
							view !== "home" ? react_jsx_runtime.jsx("button", { type: "button", className: s.back, onClick: () => setView("home"), children: t("back") }) : null,
							view === "native"
