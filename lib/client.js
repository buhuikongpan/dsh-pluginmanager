window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const s = {
			...
			cards: "pm_cards", card: "pm_card", cardTitleRow: "pm_cardTitleRow", cardTitle: "pm_cardTitle", cardHint: "pm_cardHint", back: "pm_back", tools: "pm_tools", group: "pm_group", groupHead: "pm_groupHead", health: "pm_health", healthHead: "pm_healthHead", healthBody: "pm_healthBody", healthLabel: "pm_healthLabel", healthAi: "pm_healthAi", healthAiHint: "pm_healthAiHint"
		};
		//#endregion
		//#region locales
		const zh = {
		...
		toolPluginDynamic: "工具插件（动态注册工具）",
			...
			healthFix: "修复建议",
			aiFix: "AI 修复",
			aiFixHint: "把这份「诊断 + 修复步骤」复制给一个新的 Agent 对话，由你决定是否发送。",
			aiFixCopied: "已复制诊断与修复提示词",
			aiFixFail: "无法访问剪贴板，请手动复制下方内容",
			presetTag: "预设",
		...
		toolPluginDynamic: "tool plugin (dynamically registered tools)",
			...
			whyNotEffective: "Why not effective?",
			healthReason: "Reason",
			healthFix: "Fix steps",
			aiFix: "AI fix",
			aiFixHint: "Copy this diagnosis + fix steps to a fresh Agent session; you decide whether to send.",
			aiFixCopied: "Diagnosis & fix prompt copied",
			aiFixFail: "Clipboard unavailable — copy the content below manually",
			presetTag: "preset",
		...
		function PluginRow(props) {
			...
			const copyAiFix = () => {
				const text = row.health && row.health.aiFixPrompt ? row.health.aiFixPrompt : "";
				const fail = () => { if (typeof window !== "undefined") window.alert(t("aiFixFail")); };
				try {
					if (navigator.clipboard && typeof navigator.clipboard.writeText === "function") {
						navigator.clipboard.writeText(text).then(
							() => { if (typeof window !== "undefined") window.alert(t("aiFixCopied")); },
							() => fail()
						);
					} else fail();
				} catch { fail(); }
						...
						children: [
							...
							react_jsx_runtime.jsxs("span", {
								...
								children: [
									...
									row.health && row.health.state !== "disabled"
										? react_jsx_runtime.jsx("span", {
											className: s.tag,
											"data-kind": row.health.state === "failed" ? "error" : "warn",
											title: (row.health.reasons || []).join("；"),
											children: row.health.state === "failed" ? t("loadFailed") : t("notEffective")
										})
										: null,
									phaseTag
								]
					...
					row.health
						? react_jsx_runtime.jsx("div", {
							...
							children: [
								react_jsx_runtime.jsx("button", {
									type: "button",
									className: s.healthHead,
									"aria-expanded": whyOpen,
									onClick: () => setWhyOpen((value) => !value),
									children: [
										react_jsx_runtime.jsx("span", { className: s.chevron, "data-open": whyOpen, "aria-hidden": "true", children: "›" }),
										react_jsx_runtime.jsx("span", { children: t("whyNotEffective") })
									]
								}),
								whyOpen
									? react_jsx_runtime.jsxs("div", {
										className: s.healthBody,
										children: [
											react_jsx_runtime.jsx("p", { className: s.healthLabel, children: t("healthReason") + "：" }),
											row.health.reasons.map((reason) => react_jsx_runtime.jsx("p", { className: s.desc, children: reason })),
											react_jsx_runtime.jsx("p", { className: s.healthLabel, children: t("healthFix") + "：" }),
											row.health.fixSteps.map((step, index) => react_jsx_runtime.jsx("p", { className: s.desc, children: String(index + 1) + ". " + step })),
											react_jsx_runtime.jsx("div", {
												className: s.healthAi,
												children: [
													react_jsx_runtime.jsx("button", { type: "button", className: s.btn, onClick: copyAiFix, children: "🤖 " + t("aiFix") }),
													react_jsx_runtime.jsx("span", { className: s.healthAiHint, children: t("aiFixHint") })
												]
											})
										]
									})
