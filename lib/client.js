		...
		function ManagerTab(props) {
			...
			const run = (name, verb, call, donePrefix, failPrefix) => {
				...
				call().then((result) => {
					...
					setNotice({ kind: "success", text: donePrefix + name + (result.value?.hot === true ? t("hotLive") : "") });
